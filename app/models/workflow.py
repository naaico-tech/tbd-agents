...
class Workflow(Document):
    ...
    google_adk_session: dict[str, Any] | None = None  # Persisted ADK session snapshot
    ...
    tsv_tool_results: bool = (
        False  # Render tabular tool results as TSV before adding them to context
    )
