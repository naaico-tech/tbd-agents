...
- Search [existing issues](https://github.com/naaico-tech/tbd-agents/issues) before opening a new one.
- Use a clear, descriptive title.
- Include steps to reproduce, expected vs actual behavior, and environment details (OS, Python version, Docker version).

### Suggesting Features

- Open a [feature request issue](https://github.com/naaico-tech/tbd-agents/issues/new) with a clear description of the use case.
...
6. **Commit** with a clear message using [Conventional Commits](https://www.conventionalcommits.org/) format:
    ```bash
